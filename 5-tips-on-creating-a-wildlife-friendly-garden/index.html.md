---
title: "6 Tips on Creating a Wildlife Friendly Garden ..."
...
Bird feeders are an excellent way to attract wildlife into your garden.  Installing and taking care of bird feeders has never been easier. With a new generation [Bird Feeder with Camera](https://mybirdbuddy.com/), you'll be able to see the birds visiting your garden even when you are inside. **Bird Buddy** is a **Smart Bird Feeder** that notifies users whenever a bird stops by, sending a notification via the **Bird Buddy app**. The built-in technology allows users to capture beautiful photos and video clips of the bird whilst the app gamifies the experience by recognizing birds, currently over 1000 species, and organizing them in a “Pokémon GO like” collection. The feeder unit also notifies users when bird seed levels are running low, is WiFi enabled and has an optional solar panel. Users can also switch between units and streams, sharing their photos and videos with other users.
...
- [HTML article](https://gardening.allwomenstalk.com/5-tips-on-creating-a-wildlife-friendly-garden/)
